  ...
  if (functionName === 'save_opening_balance') {
    ...
    try {
      ...
      if (invoiceError) {
        ...
        callResult = { success: false, error: invoiceError.message };
        ...
        callResult = { success: true, data: invoiceData };
      } else {
    ...
    try {
      ...
      if (paymentError) {
        ...
        callResult = { success: false, error: paymentError.message };
        ...
        callResult = { success: true, data: paymentData };
      } else {
