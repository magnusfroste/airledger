...
const BalanceSheet = () => {
  ...
  const fetchBalanceSheetData = async () => {
    ...
    try {
      ...
      const { data: entriesData, error: entriesError } = await supabase
        ...
        .lte('airledger_transactions.transaction_date', balanceDate);
  ...
  return (
    <div className="container px-6 py-6 pb-20 sm:pb-6 max-w-4xl mx-auto animate-fade-in">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Finansiell ställning per {format(new Date(balanceDate), 'PPP', { locale: sv })}
          </p>
        </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className={`font-semibold ${
                ...
                {formatCurrency(
                  Math.abs((balanceData?.totalAssets || 0) - 
                           ((balanceData?.totalLiabilities || 0) + (balanceData?.totalEquity || 0)))
                )}
              </div>
            </div>
          </div>
      ...
      <div className="space-y-6">
        ...
        {renderAccountSection(
          ...
          balanceData?.totalLiabilities || 0,
