...
export const TESTBOLAGET_SCENARIOS: DemoScenario[] = [
  ...
  },
  {
    ...
    quarter: 'Q4',
    month: 11,
    message: 'Bokför momsredovisning Q3: ingående moms 4 200 kr och utgående moms 37 500 kr, betala mellanskillnaden',
    description: 'Momsdeklaration kvartal 3',
    expected_template: 'Momsredovisning',
    expected_total: 33300,
  },
  {
    id: 'q4-05',
    quarter: 'Q4',
    month: 12,
    message: 'Bokför avskrivning på datorer med 5 000 kr för räkenskapsåret',
  ...
  },
  {
    ...
    quarter: 'Q4',
    month: 12,
    message: 'Bokför upplupna kostnader för revision 15 000 kr',
  ...
  },
  {
    ...
    quarter: 'Q4',
    month: 12,
    message: 'Bokför avsättning till periodiseringsfond 50 000 kr',
  ...
  },
  {
    ...
    quarter: 'Q4',
    month: 12,
    message: 'Bokför skatteavsättning bolagsskatt 41 200 kr baserat på resultat 200 000 kr',
    description: 'Bokslut – bolagsskatt 20.6%',
    expected_template: 'Skatteavsättning bolagsskatt',
    expected_total: 41200,
  },

  // ── Kantfall (kompletta meddelanden – fråge-scenarier lever i backend-testsviten) ──
  {
    id: 'edge-01',
    quarter: 'edge',
    month: 0,
    message: 'Faktura till Ny Kund 20 000 kr för konsulttjänster',
    description: 'Kort format – igenkänning',
    expected_template: 'Försäljning tjänster 25%',
  ...
  },
  {
    ...
    quarter: 'edge',
    month: 0,
    message: 'Köpt kaffe och fika till kontoret 245 kr',
    description: 'Litet belopp – kontorsmaterial',
    expected_template: 'Kontorsmaterial inköp',
    expected_total: 245,
  },
  {
    ...
    quarter: 'edge',
    month: 0,
    message: 'Kreditfaktura till Kund AB -5 000 kr för felaktig faktura',
  ...
  },
  {
    ...
    quarter: 'edge',
    month: 0,
    message: 'Kundförlust Dålig Kund AB 25 000 kr, konstaterad förlust',
    description: 'Ovanlig transaktion – kundförlust',
